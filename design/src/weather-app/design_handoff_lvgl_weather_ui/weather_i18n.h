...
typedef struct {
    ...
    const char *temperature, *wind_speed, *time_format, *language, *h24, *h12;
    ...
    const char *network, *configure_network, *wifi_title, *scan, *scanning, *no_networks, *secured, *open_net;
